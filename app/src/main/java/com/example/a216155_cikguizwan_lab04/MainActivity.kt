...
import com.example.a216155_cikguizwan_lab04.ui.them.CleanGrayBg
...
import com.example.a216155_cikguizwan_lab04.ui.them.SurfaceWhite
...
fun StudyMatePreview() {
    // Provide fake values so the preview works
    val navController = rememberNavController()
    val viewModel: StudyMateViewModel = viewModel()
...
@Composable
fun StudyMateApp(navController: NavHostController, viewModel: StudyMateViewModel) { // Added Parameters
    ...
    Scaffold(
        ...
        Box(modifier = Modifier.fillMaxSize()) {
            when (currentPage) {
                ...
                "menu" -> MenuScreen(paddingValues) // Pass paddingValues
...
fun DashboardScreen(paddingValues: PaddingValues, onSearchClick: () -> Unit) {
    Column(modifier = Modifier
        .fillMaxSize()
        .background(com.example.a216155_cikguizwan_lab04.CleanGrayBg)
        .padding(paddingValues)
        .verticalScroll(rememberScrollState())) {
...
fun CalendarHeader(
    ...
    Row(
        ...
        OutlinedButton(
            onClick = onToday,
            shape = RoundedCornerShape(12.dp),
            border = BorderStroke(2.dp, com.example.a216155_cikguizwan_lab04.CleanGrayBg)
        ) {
